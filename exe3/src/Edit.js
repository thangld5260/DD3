...
export default function Update({ navigation }) {
    ...
    const [msnv, setMSNV] = useState(navigation.getParam('msnv'));
    ...
    return (
        <View style={styles.container}>
            <View style={styles.viewCenter}>
                ...
                <Text style={styles.text}>Mã số nhân viên</Text>
                <TextInput style={styles.textInput} onChangeText={msnv => setMSNV(msnv)} value={msnv} />
